...
function DroupDown({value , setValue}) {
  return (
    <div className='flex justify-center itmes-center flex-col w-1/2 h-full'>
        <form>
            <div className='h-1/2 w-full flex items-center p-[1.4vmax]'><label className='text-black text-[1.5vmax] font-bold' htmlFor='visibility'>Playlist Visibility</label></div>
