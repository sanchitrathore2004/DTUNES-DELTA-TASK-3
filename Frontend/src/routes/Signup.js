...
function Signup() {
  ...
  return (
    ...
    { loaded && <div className='flex flex-col rounded-md w-[35vmax] h-[48vmax] my-2'>
    ...
    <div className='flex justify-center items-center'><button style={{ 
          background: 'linear-gradient(45deg, #1DB954, #0000)', 
          color: 'white' 
        }} className='rounded-[0.5vmax] text-white p-[1vmax] font-bold text-[1.1vmax] bg-white' onClick={(e)=>{e.preventDefault();
    setLoaded(false); 
      signUpBtn();
